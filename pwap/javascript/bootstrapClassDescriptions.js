module.exports = {
    ...
    'h5': '<h5>Heading 5</h5>',
    'h6': '<h6>Heading 6</h6>',
    'ol': '<ol><li>Item 1</li><li>Item 2</li><li>Item 3</li></ol><p>An ordered list.</p>',
    'ul':' <ul><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul><p>An unordered list.</p>',
    'p': '<p>A standard paragraph</p>',
    '.text-muted': '<p class="text-muted">Muted text</p>',
    '.text-primary': '<p class="text-primary">Provides extra visual weight and identifies the primary content.</p>',
    '.text-success': '<p class="text-success">Indicates successful or positive text.</p>',
    '.text-info': '<p class="text-info">Informational text</p>',
    '.text-warning': '<p class="text-warning">Indicates caution should be taken with this text.</p>',
    '.text-danger': '<p class="text-danger">Indicates dangerous or potentially negative text.</p>',
